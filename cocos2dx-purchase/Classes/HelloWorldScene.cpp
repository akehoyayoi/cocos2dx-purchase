...
{
    EventHandlers::getInstance()->addHandler(this);
}

HelloWorld::~HelloWorld()
{
    EventHandlers::getInstance()->removeHandler(this);
}
...
{
    CCLOG("close");
    ProductInfo productInfo("your product id","your product name",/* your product price */ 0);
    PurchaseController::getInstance()->purchase(productInfo);
}
